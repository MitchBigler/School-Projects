...
def generate_subkeys(key):
    ...
    bit_key = [int(b) for b in f"{key:064b}"]

    permuted_key = permute(bit_key, PC1)
    ...
    for shift in SHIFTS:
        ...
        # Appended permuted result to subkeys
...
def encrypt(plain, key):
    ...
    for i in range(16):
        ...
        p_permuted = permute(substituted, P)
        new_R = [l ^ p for l, p in zip(L, p_permuted)]
